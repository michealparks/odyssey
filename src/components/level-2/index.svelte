...
{#if $gltf}
  <T is={$gltf.nodes.floor_center} receiveShadow position.y={-0.29} {visible} />
  ...
  >
    <Joint
      {switchState}
      on:enter={() => handleEnter(2)}
      on:exit={() => handleExit(2)}
      rotation={Math.PI / 4}
    />
  </T>
  <T
  ...
  >
    <Joint
      {switchState}
      on:enter={() => handleEnter(3)}
      on:exit={() => handleExit(3)}
      rotation={Math.PI / 2}
    />
  </T>
  <T
  ...
  >
    <Joint
      {switchState}
      on:enter={() => handleEnter(4)}
      on:exit={() => handleExit(4)}
  ...
  >
    <Joint
      {switchState}
      on:enter={() => handleEnter(5)}
      on:exit={() => handleExit(5)}
      rotation={Math.PI}
    />
  </T>
  <T
  ...
  >
    <Joint
      {switchState}
      on:enter={() => handleEnter(6)}
      on:exit={() => handleExit(6)}
  ...
  >
    <Joint
      {switchState}
      on:enter={() => handleEnter(7)}
      on:exit={() => handleExit(7)}
  ...
  >
    <Joint
      {switchState}
      on:enter={() => handleEnter(8)}
      on:exit={() => handleExit(8)}
